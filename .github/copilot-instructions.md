...
## Git Operation Rules
- Default branch (`main` or `main`) is protected. No one can push directly to it. All changes must be made via PRs.
- The git-flow is used for development. Only `main`, `develop`, and `release/*` are required
